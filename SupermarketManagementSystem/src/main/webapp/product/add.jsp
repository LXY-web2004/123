...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; font-family: "微软雅黑"; }
        ...
        .form-title { text-align: center; font-size: 20px; color: #333; margin-bottom: 20px; padding-bottom: 10px; border-bottom: 2px solid #0066cc; }
        ...
        .submit-btn, .reset-btn { flex: 1; padding: 8px 0; border: none; border-radius: 4px; cursor: pointer; font-size: 14px; }
    ...
    <div class="form-card">
        ...
        <form action="${pageContext.request.contextPath}/product/add" method="post">
            <div class="form-item">
                ...
                <input type="text" name="productNo" class="form-input" required placeholder="格式：SP+3位数字（如SP001）">
            </div>

            <div class="form-item">
                <label class="form-label">商品名称<span class="required">*</span></label>
                <input type="text" name="productName" class="form-input" required placeholder="请输入商品名称">
            </div>
            ...
            <div class="form-item">
                ...
                <input type="number" name="price" class="form-input" required step="0.01" min="0.01" placeholder="最多两位小数">
            </div>

            <div class="form-item">
                <label class="form-label">库存数量<span class="required">*</span></label>
                <input type="number" name="stock" class="form-input" required min="0" placeholder="非负整数">
            </div>

            <div class="form-item">
                <label class="form-label">生产日期<span class="required">*</span></label>
                <input type="date" name="productionDate" class="form-input" required>
            </div>

            <div class="form-item">
                <label class="form-label">供应商</label>
                <input type="text" name="supplier" class="form-input" placeholder="可选，输入供应商名称">
            </div>

            <div class="form-item">
                <label class="form-label">商品描述</label>
                <input type="text" name="description" class="form-input" placeholder="可选，输入商品详细描述">
            </div>
